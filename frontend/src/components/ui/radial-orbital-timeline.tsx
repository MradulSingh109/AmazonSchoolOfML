...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index: number, total: number) => {
    ...
    const radius = 160; // Slightly smaller radius to fit perfectly in a card
  ...
  return (
    <div
      className="w-full h-[500px] flex flex-col items-center justify-center bg-transparent overflow-hidden relative select-none"
      ref={containerRef}
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    width: `${item.completion * 0.5 + 40}px`,
                    height: `${item.completion * 0.5 + 40}px`,
                    left: `-${(item.completion * 0.5 + 40 - 40) / 2}px`,
                    top: `-${(item.completion * 0.5 + 40 - 40) / 2}px`,
                  }}
                ></div>
